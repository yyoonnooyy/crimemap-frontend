...
function Infopost () {
	...
	useEffect(() => {
		...
		fetch("http://localhost:8080/InfoPost/" + post_num, requestOptions)
		    ...
		    .then((response) => {
		    	...
		    	if (response.flag == "Y") {
					...
					fetch("http://localhost:8080/InfoPost/Image/" + imgId, requestOptions2)
					    .then((response) => response.json())
					    .then((response) => {
    ...
    function onClickDelete() {
    	if(flag == "Y") {
			...
			fetch("http://localhost:8080/InfoPost/Image/" + imgId2, requestOptions)
				...
				.then((response) => {
					...
					fetch("http://localhost:8080/InfoPost/" + post_num, requestOptions2)
						.then((response) => response.text())
						.then((response) => {
							alert('글 삭제가 완료되었습니다.');
						},
			        ...
			        <TableBody>
			        	<TableRow
			                ...
			                >
			                  ...
			                  <TableCell align="center">사용자1</TableCell>
			                </TableRow>
			        </TableBody>
